...
const SecuritySuiteMock = {
  getPublicKey: asyncFunction(str),
  getSharedKey: asyncFunction(str),
  encryptBySharedKey: asyncFunction(str),
  decryptBySharedKey: asyncFunction(str),
  encrypt: asyncFunction(str),
  decrypt: asyncFunction(str),
  deviceHasSecurityRisk: asyncFunction(false),
  fetch: asyncFunction(fetchResponse),
  SecureStorage: asMock,
};

module.exports = SecuritySuiteMock;
