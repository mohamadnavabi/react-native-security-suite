...
import com.securitysuite.databinding.TransactionItemBodyLineBinding
import com.securitysuite.databinding.TransactionItemCopyBinding
import com.securitysuite.databinding.TransactionItemHeadersBinding
import com.securitysuite.databinding.TransactionItemImageBinding
import com.securitysuite.internal.support.ChessboardDrawable
import com.securitysuite.internal.support.SpanTextUtil
import com.securitysuite.internal.support.highlightWithDefinedColors
import com.securitysuite.internal.support.highlightWithDefinedColorsSubstring
import com.securitysuite.internal.support.indicesOf
...
internal class TransactionBodyAdapter(private val onCopyBodyListener: () -> Unit) :
    ...
    override fun onCreateViewHolder(
        ...
        return when (viewType) {
            TYPE_HEADERS -> {
                val headersItemBinding = TransactionItemHeadersBinding.inflate(inflater, parent, false)
                TransactionPayloadViewHolder.HeaderViewHolder(headersItemBinding)
            }

            TYPE_BODY_LINE -> {
                val bodyItemBinding = TransactionItemBodyLineBinding.inflate(inflater, parent, false)
                TransactionPayloadViewHolder.BodyLineViewHolder(bodyItemBinding)
            }

            TYPE_COPY -> {
                val copyItemBinding =
                    TransactionItemCopyBinding.inflate(inflater, parent, false)
                TransactionPayloadViewHolder.CopyViewHolder(copyItemBinding, onCopyBodyListener)
            }

            else -> {
                val imageItemBinding = TransactionItemImageBinding.inflate(inflater, parent, false)
...
internal sealed class TransactionPayloadViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    internal class HeaderViewHolder(
        private val headerBinding: TransactionItemHeadersBinding,
    ...
    internal class CopyViewHolder(
        private val copyBinding: TransactionItemCopyBinding,
    ...
    internal class BodyLineViewHolder(
        private val bodyBinding: TransactionItemBodyLineBinding,
    ...
    internal class ImageViewHolder(
        private val imageBinding: TransactionItemImageBinding,
